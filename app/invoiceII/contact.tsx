...
const Contact = () => {
    ...
    return (
        <section className="mt-16 lg:mt-32 pb-20 px-5 lg:px-0 container mx-auto">
            <div className="lg:flex">
                <div className="lg:w-50% pt-6">
                    <div className="max-w-595px mx-auto lg:mr-auto h-402px bg-white shadow-md rounded-30"></div>
                </div>
                <div className="pt-6 lg:pt-0 lg:w-50%">
                    <div className="max-w-595px lg:max-w-511px h-374 md:h-473px mx-auto lg:mx-0 lg:ml-auto rounded-20 bg-gradient-to-r from-gradientBlue via-gradientPurple to-gradientIndigo">
