            ...
            <div className='xl:max-w-93% xl:ml-auto 2xl:max-w-none'>
                <div className='gap-10  mt-14 lg:mt-24 lg:flex flex-row'>
                    <div className='px-5 lg:px-0 flex flex-col space-y-0 md:space-y-6 text-start mt-14 mb-10 lg:w-1/2'>
                        <div className='mb-6'>
                            <h6 className='text-sm md:text-base lg:text-lg xl:text-xl font-normal text-lightBlue mb-4'>Invoicing</h6>
                            <h3 className='text-black max-w-521 text-2xl md:text-3xl lg:text-36 xl:text-4xl mb-4 font-medium leading-42 md:leading-52'>Your business&rsquo; financial <br />support starts here</h3>
